angular.module('app').factory('DataStorageService', function(){
	...
	var data = [
		...
		},
		{
			...
			url: '//2.taobao.com/item.htm?spm=2007.1000337.16.4.IjtmQj&id=43659751169',
			price: '2100.00',
			date: 1441157171835
		},		
		{
		...
		},	
		{
			...
			url: '//2.taobao.com/item.htm?id=521368700651',
			price: '7500.00',
			date: 1441157171835
		},	
		{
		...
		},
		{
			...
			url: '//2.taobao.com/item.htm?id=5213288708871',
			price: '2080.00',
			date: 1441157171835
		},		
		{
	...
	return {
		get: function () {
			console.log("This is the get method from DataStorageService");
		}
	}
})